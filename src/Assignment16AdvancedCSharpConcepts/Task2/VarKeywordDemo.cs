namespace Assignment16AdvancedCSharpConcepts.Task2
{
    ...
    internal class VarKeywordDemo
    {
        ...
        public void RunDemo()
        {
            ...
            ConsoleHelpers.DisplayCodeSnippet("var stringValue = \"String value\";");
            ...
            ConsoleHelpers.DisplayCodeSnippet("stringValue = \"Another string value.\";");
            ...
            // var value;
            ConsoleHelpers.DisplayCodeSnippet("var value;");
            ...
            // var value = null;
            ConsoleHelpers.DisplayCodeSnippet("var value = null;");
