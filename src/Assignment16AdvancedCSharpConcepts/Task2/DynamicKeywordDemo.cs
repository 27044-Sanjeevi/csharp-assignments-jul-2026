namespace Assignment16AdvancedCSharpConcepts.Task2
{
    ...
    internal class DynamicKeywordDemo
    {
        ...
        public void RunDemo()
        {
            ...
            ConsoleHelpers.DisplayCodeSnippet("dynamic stringValue = \"String value\";");

            ConsoleHelpers.DisplayStatus("2. Trying to assign a different type value to the variable..");

            stringValue = 10;
            ConsoleHelpers.DisplayCodeSnippet("stringValue = 10;");
            ...
            dynamic value;
            value = "String";
            ConsoleHelpers.DisplayCodeSnippet("dynamic value;");
            ...
            ConsoleHelpers.DisplayCodeSnippet("dynamic listObject = new List<int>();\nlistObject.ToString()");
            ConsoleHelpers.DisplaySuccessMessage("This doesn't cause any compile time error because the compiler assumes that the unknown method exists..");
